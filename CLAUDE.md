...
**Important**: The database uses TypeScript/Sequelize models (see `docs/DATABASE_OVERVIEW.md`) but this Python app accesses it via raw SQL. Table structure must match the Sequelize schema.
